    ...
    return (
        <div className='py-20 px-4 max-w-6xl mx-auto z-0'>
            ...
            <div className='grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                ...
                <div className='card flex flex-col items-center dark:bg-slate-900 p-3 rounded-2xl bg-white'>
                    <img src={image2} alt='Home Page' className='w-full h-auto mb-4 rounded-lg shadow-md' />
                ...
                <div className='card flex flex-col items-center dark:bg-slate-900 p-3 rounded-2xl bg-white'>
                    <img src={image3} alt='Home Page' className='w-full h-auto mb-4 rounded-lg shadow-md' />
                ...
                <div className='card flex flex-col items-center dark:bg-slate-900 p-3 rounded-2xl bg-white'>
                <img src={image4} alt='Home Page' className='w-full h-auto mb-4 rounded-lg shadow-md' />
                ...
                <div className='card flex flex-col items-center dark:bg-slate-900 p-3 rounded-2xl bg-white'>
                    <img src={image5} alt='Home Page' className='w-full h-auto mb-4 rounded-lg shadow-md' />
                ...
                <div className='card flex flex-col items-center dark:bg-slate-900 p-3 rounded-2xl bg-white'>
                    <img src={image6} alt='Home Page' className='w-full h-auto mb-4 rounded-lg shadow-md' />
